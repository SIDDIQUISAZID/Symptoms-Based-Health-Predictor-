...
<div class="row">
    <div class="jumbotron"style="height:100px;width: 1040px;margin: 15px">
                    ...
                    <div class="col-md-4">
                       <a href="Adddisease.jsp"> <h2 class="text-danger" style="font-family:Philosopher">Add Disease</h2></a>
                        </div>
                        
                      <div class="col-md-4">
                     <a href="patient.jsp"> <h2 class="text-danger" style="font-family:Philosopher">View Disease</h2></a>
                        </div> 
                        
                       <div class="col-md-4">
                           <a href="Patientlogin.jsp">  <h2 class="text-danger" style="font-family:Philosopher">View FeedBack</h2></a>
                        </div>  
