...
<div class="container">
   ...
   <div class="jumbotron"style="height:350px;width: 1040px;margin: 15px">
   <center>
   <p class="text-danger">ADMIN LOGIN </p>
   </center>
       <form action ="LoginAction" method="post">
    <div class="form-group">
      <label for="email">Email:</label>
      <input type="email" class="form-control" id="email" placeholder="Enter ID" name="userid">
    </div>
    <div class="form-group">
 ...
 ${requestScope.msg}  </font>
  ...
  <button type="button" class="btn btn-danger">Forggot Password</button>
  </center>
